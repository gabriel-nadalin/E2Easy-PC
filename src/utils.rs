...
use crate::{groups::traits::Group, P, Number, ModNumber, NumberNZ};
use crypto_bigint::{RandomMod, rand_core::OsRng, modular::ConstMontyParams};

pub fn get_group_params() -> (NumberNZ, ModNumber) {
    // 256-bits example
    ...
    // let p: ModNumberParams;
    // impl_modulus!(p, Number, "");
    ...
    let g = ModNumber::new(&temp_g).square(); 
    return (q, g)
}

...
use crate::{N, Ciphertext, Number, NumberNZ, ModNumber, ModNumberParams};
...
pub fn get_exponent(q: &NumberNZ) -> Option<Number> {
    return Some(Number::random_mod(&mut OsRng, &q))
}

pub fn get_generator(p: &ModNumberParams) -> Option<ModNumber> {
...
// No longer being used --> No one wants to wait days until a 3072-bit prime is generated...
/*
